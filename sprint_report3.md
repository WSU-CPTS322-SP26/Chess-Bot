 ...
 * Updated menu UI featuring new fonts, button placement, and wallpaper
 * Improved QOL improvements within the game screen to display information clearer
 * Sections within the game screen for better readbility
...
Here are links to issues we worked on but did not complete in this sprint:
   ...
   * https://github.com/WSU-CPTS322-SP26/Chess-Bot/issues/18
   Focused efforts to improve quality of UI to make the application more user friendly.
